...
public class c03_replace {
    public static void main(String[] args) {
        ...
        System.out.println(str.replace("a", "")); // Jv Cndir  // All a's are replaced. There's another method to replace just one a.
        System.out.println(str.replace("v", "T"));  // JaTa Candir
